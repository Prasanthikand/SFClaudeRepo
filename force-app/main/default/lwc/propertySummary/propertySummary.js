...
export default class PropertySummary extends NavigationMixin(LightningElement) {
    ...
    get hasNoPropertyId() { return this.propertyId === undefined; }
    get propertyName() { return getFieldValue(this.property.data, NAME_FIELD); }
    get pictureURL() { return getFieldValue(this.property.data, PICTURE_FIELD); }
    ...
    handlePropertySelected(message) { this.propertyId = message.propertyId; }
