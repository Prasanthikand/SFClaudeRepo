...
exports.registerCustomSa11yRules = exports.updateAutoCheckOpts = exports.registerRemoveChild = exports.defaultSa11yOpts = exports.improvedChecksFilter = void 0;
/*
...
function registerRemoveChild() {
    ...
    Element.prototype.removeChild = function (oldChild) {
        if (oldChild.parentNode === this && !(0, automatic_1.getOriginalDocumentBodyHtml)()) {
            (0, automatic_1.setOriginalDocumentBodyHtml)(document?.body?.innerHTML ?? '');
        }
        return originalRemoveChild.call(this, oldChild);
    };
}
exports.registerRemoveChild = registerRemoveChild;
function updateAutoCheckOpts(autoCheckOpts) {
...
exports.updateAutoCheckOpts = updateAutoCheckOpts;
function registerCustomSa11yRules() {
    (0, common_1.registerCustomRules)(preset_rules_1.changesData, preset_rules_1.rulesData, preset_rules_1.checkData);
}
exports.registerCustomSa11yRules = registerCustomSa11yRules;
